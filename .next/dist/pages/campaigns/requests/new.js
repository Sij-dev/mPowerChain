...
var RequestNew = function (_Component) {
    ...
    function RequestNew() {
        ...
        return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = RequestNew.__proto__ || (0, _getPrototypeOf2.default)(RequestNew)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(event) {
                var campaignInstance, _this$state, value, description, recipient, accounts;
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                campaignInstance = (0, _campaign2.default)(_this.props.address);
                            ...
                            case 7:
                                ...
                                _context.next = 10;
                                return campaignInstance.methods.createRequest(description, _web2.default.utils.toWei(value, 'ether'), recipient).send({ from: accounts[0] });
    ...
    (0, _createClass3.default)(RequestNew, [{
        ...
        value: function render() {
            ...
            })), _react2.default.createElement(_semanticUiReact.Message, { error: true, header: 'Campaign Create request error', content: this.state.errorMessage }), _react2.default.createElement(_semanticUiReact.Button, { secondary: true, loading: this.state.loading }, ' Create ')));
        }
    }], [{
        key: 'getInitialProps',
        value: function () {
